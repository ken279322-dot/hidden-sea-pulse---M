const questions = [
  ...
  {
    question: "คุณที่กำลังตกลงสู่พื้นทะเลด้วยกำลังของชายที่รอดชีวิตมาได้เพราะคุณ คุณจะทำยังไง?",
    answers: [
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function playClickSound() {
    // ให้เล่นตั้งแต่ต้นทุกครั้ง
    clickSound.currentTime = 0;
    clickSound.play();
  }

  // เพิ่ม event ให้ปุ่มที่มี class "play-sound"
  document.querySelectorAll('.play-sound').forEach(button => {
    button.addEventListener('click', playClickSound);
  });

  // ถ้าใช้ JS สร้างปุ่มคำตอบแบบ dynamic ต้อง bind event ใหม่หลัง render
  ...
  observer.observe(answerContainer, { childList: true });
});
...
nextButton.addEventListener("click", () => {
    clickSound.play(); // ✅ เพิ่มบรรทัดนี้
